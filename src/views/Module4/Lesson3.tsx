...
} from "@/lib/splMovieReview3";
import { MovieCoordinator3 } from "@/classes/MovieCoordiantor3";
...
const Module4Lesson3 = () => {
  ...
  const loadMovieData = async (
    ...
    if (connection) {
      const movies = await MovieCoordinator3.fetchPage(
        connection,
        page,
        pageSize,
        search,
      ...
      const totalMovies = MovieCoordinator3.accounts.length;
      setMovies(movies);
